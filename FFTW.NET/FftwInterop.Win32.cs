...
namespace FFTW.NET
{
	...
	public static partial class FftwInterop
	{
		...
		[DllImport("libfftw3-3-x86", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_plan_with_nthreads")]
		static extern void fftw_plan_with_nthreads_x86(int nthreads);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_plan_with_nthreads")]
		static extern void fftw_plan_with_nthreads_x64(int nthreads);
		...
		static extern IntPtr fftw_plan_dft_x86(int rank, [MarshalAs(UnmanagedType.LPArray)] int[] n, IntPtr arrIn, IntPtr arrOut, DftDirection direction, PlannerFlags flags);
		...
		public static IntPtr fftw_plan_dft(int rank, [MarshalAs(UnmanagedType.LPArray)] int[] n, IntPtr arrIn, IntPtr arrOut, DftDirection direction, PlannerFlags flags)
		{
		...
		static extern IntPtr fftw_plan_dft_r2c_x86(int rank, [MarshalAs(UnmanagedType.LPArray)] int[] n, IntPtr arrIn, IntPtr arrOut, PlannerFlags flags);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_plan_dft_r2c")]
		static extern IntPtr fftw_plan_dft_r2c_x64(int rank, [MarshalAs(UnmanagedType.LPArray)] int[] n, IntPtr arrIn, IntPtr arrOut, PlannerFlags flags);

		public static IntPtr fftw_plan_dft_r2c(int rank, [MarshalAs(UnmanagedType.LPArray)] int[] n, IntPtr arrIn, IntPtr arrOut, PlannerFlags flags)
		{
		...
		static extern IntPtr fftw_plan_dft_c2r_x86(int rank, [MarshalAs(UnmanagedType.LPArray)] int[] n, IntPtr arrIn, IntPtr arrOut, PlannerFlags flags);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_plan_dft_c2r")]
		static extern IntPtr fftw_plan_dft_c2r_x64(int rank, [MarshalAs(UnmanagedType.LPArray)] int[] n, IntPtr arrIn, IntPtr arrOut, PlannerFlags flags);
		...
		static extern void fftw_destroy_plan_x86(IntPtr plan);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_destroy_plan")]
		static extern void fftw_destroy_plan_x64(IntPtr plan);

		public static void fftw_destroy_plan(IntPtr plan)
		{
		...
		static extern void fftw_execute_x86(IntPtr plan);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_execute")]
		static extern void fftw_execute_x64(IntPtr plan);
		...
		[DllImport("libfftw3-3-x86", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_export_wisdom_to_filename")]
		[return: MarshalAs(UnmanagedType.Bool)]
		static extern bool fftw_export_wisdom_to_filename_x86([MarshalAs(UnmanagedType.LPStr)] string filename);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_export_wisdom_to_filename")]
		[return: MarshalAs(UnmanagedType.Bool)]
		static extern bool fftw_export_wisdom_to_filename_x64([MarshalAs(UnmanagedType.LPStr)] string filename);

		public static bool fftw_export_wisdom_to_filename([MarshalAs(UnmanagedType.LPStr)] string filename)
		{
		...
		[DllImport("libfftw3-3-x86", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_import_wisdom_from_filename")]
		[return: MarshalAs(UnmanagedType.Bool)]
		static extern bool fftw_import_wisdom_from_filename_x86([MarshalAs(UnmanagedType.LPStr)] string filename);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_import_wisdom_from_filename")]
		[return: MarshalAs(UnmanagedType.Bool)]
		static extern bool fftw_import_wisdom_from_filename_x64([MarshalAs(UnmanagedType.LPStr)] string filename);

		public static bool fftw_import_wisdom_from_filename([MarshalAs(UnmanagedType.LPStr)] string filename)
		{
		...
		[DllImport("libfftw3-3-x86", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_import_wisdom_from_string")]
		[return: MarshalAs(UnmanagedType.Bool)]
		static extern bool fftw_import_wisdom_from_string_x86([MarshalAs(UnmanagedType.LPStr)] string wisdom);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_import_wisdom_from_string")]
		[return: MarshalAs(UnmanagedType.Bool)]
		static extern bool fftw_import_wisdom_from_string_x64([MarshalAs(UnmanagedType.LPStr)] string wisdom);

		public static bool fftw_import_wisdom_from_string([MarshalAs(UnmanagedType.LPStr)] string wisdom)
		{
		...
		static extern void fftw_export_wisdom_x86([MarshalAs(UnmanagedType.FunctionPtr)] WriteCharHandler writeChar, IntPtr data);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_export_wisdom")]
		static extern void fftw_export_wisdom_x64([MarshalAs(UnmanagedType.FunctionPtr)] WriteCharHandler writeChar, IntPtr data);
		...
		static extern IntPtr fftw_malloc_x86(IntPtr size);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_malloc")]
		static extern IntPtr fftw_malloc_x64(IntPtr size);

		public static IntPtr fftw_malloc(IntPtr size)
		{
		...
		static extern int fftw_alignment_of_x86(IntPtr ptr);

		[DllImport("libfftw3-3-x64", CallingConvention = CallingConvention.Cdecl, EntryPoint = "fftw_alignment_of")]
		static extern int fftw_alignment_of_x64(IntPtr ptr);

		public static int fftw_alignment_of(IntPtr ptr)
		{
